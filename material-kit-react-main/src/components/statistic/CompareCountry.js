...
const CompareCountry = ({ getCountry }) => {
  const [country, setCountry] = useState('');

  const genRandomData = () => (Math.floor(Math.random() * 100000));
  ...
  return (
    ...
    >
      <Grid container spacing={1}>
        ...
        <Grid item lg={12} sm={12} xl={12} xs={12}>
          <NativeSelect
            ...
            onChange={({ target }) => {
              ...
              getCountry({ ...countryAData, name: country });
            }}
          >
        ...
        <Grid item lg={12} sm={12} xl={12} xs={12}>
          <CardData metric="your selected country is" metricValue={country} />
        </Grid>
