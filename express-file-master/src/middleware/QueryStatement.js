...
const getTotalCaseWorldwide = (searchDate) => `SELECT location,date,total_cases,total_deaths,
...
const getTotalCaseByNow = (searchDate) => `SELECT date,location,total_cases,total_deaths,new_cases,new_deaths,iso_code,
